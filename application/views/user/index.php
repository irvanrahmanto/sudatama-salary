      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <table class="table">
            ...
            <a href="#" class="btn btn-secondary btn-lg" role="button" >Previous</a>
            <a href="#" class="btn btn-secondary btn-lg" role="button">Next</a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Sudatama Coorporation <?= date('Y'); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
